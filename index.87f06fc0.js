let e,t,o;const r="theme",n="dark-theme",l={username:{required:!0,errorMessage:"Please enter your name"},phone_number:{required:!0,pattern:/^[\d\s+()-]{7,20}$/,errorMessage:"Enter a valid phone number"},email:{required:!0,pattern:/^[^\s@]+@[^\s@]+\.[^\s@]+$/,errorMessage:"Enter a valid email address"}};function s(t){var r;e&&(r=t.currentTarget.dataset.modalType,o&&r&&("order"===r?(o.innerHTML=`
