!function(){let e,r,t;let o="theme",n="dark-theme",s={username:{required:!0,errorMessage:"Please enter your name"},phone_number:{required:!0,pattern:/^[\d\s+()-]{7,20}$/,errorMessage:"Enter a valid phone number"},email:{required:!0,pattern:/^[^\s@]+@[^\s@]+\.[^\s@]+$/,errorMessage:"Enter a valid email address"}};function a(e,r){e.textContent=r,e.closest("label").classList.add("is-invalid")}function l(r){var o;e&&(o=r.currentTarget.dataset.modalType,t&&o&&("order"===o?(t.innerHTML=`
